...
@MODEL_FACTORY.register_module(module_name='CLIP_ViT_L14_Model_Prompt_Caption')
class CLIP_ViT_L14_Model_Prompt_Caption(BaseModel):
    def __init__(self, config=None, num_classes=10):
        super(CLIP_ViT_L14_Model_Prompt_Caption, self).__init__(config, num_classes)
        self.config = config
        self.epoch = 0
