...
CUDA_VISIBLE_DEVICES="$GPU_IDS" accelerate launch $MULTI_GPU_ARG --num_processes "$NUM_PROCESSES" train_clip.py --config "./config/configs_dir/prompt_learn.yaml" --opt task_name='clip_vit_l14' dataset.sampler='softmax_triplet'
