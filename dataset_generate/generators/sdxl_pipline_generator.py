...
@BaseGenerator.register("StableDiffusionXL_Pipline_Generator")
class StableDiffusionXL_Pipline_Generator(BaseGenerator):
    """
    FLUX.1-dev图像生成器
    """
    ...
    def load_model(self, device=None):
        ...
        try:
            ...
            self.pipeline = StableDiffusionXLPipeline.from_single_file(
                self.model_params.get("single_file_url"),
