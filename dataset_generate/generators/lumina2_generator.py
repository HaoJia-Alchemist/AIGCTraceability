...
@BaseGenerator.register("Lumina2_Generator")
class Lumina2_Generator(BaseGenerator):
    """
    ...
    def load_model(self, device=None):
        ...
        try:
            ...
            self.pipeline = pipe = Lumina2Pipeline.from_pretrained("Alpha-VLLM/Lumina-Image-2.0",
